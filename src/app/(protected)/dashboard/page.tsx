...
const DOCTRINES: DoctrineLink[] = [
  ...
  { id: "salami-slicing", keywords: ["Salami Dilimleme Stratejisi", "Salami Dilimleme", "Salam Dilimleme"] },
  ...
  { id: "premeditatio-malorum", keywords: ["Premeditatio Malorum", "Olumsuz Senaryo Provası", "En Kötü Senaryo Provası"] },
  ...
  { id: "tactical-triangulation", keywords: ["Taktiksel Üçgenleme", "Üçgenleme Stratejisi", "Triangülasyon"] },
